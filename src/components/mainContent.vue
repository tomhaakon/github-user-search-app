<template>
  ...
  <section v-if="userStore.showUser">
    <div
      class="md:px-10 lg:px-14 dark:bg-[#1E2A47] bg-white mx-7 rounded-2xl px-5 shadow-lg dark:shadow-none"
    >
      ...
      <div class="grid grid-cols-2 bg-slate-400">
        ...
        <!-- user nickname -->
        <div class="col-start-2 pb-5 bg-green-400">
          <div class="">
            <h1
              class="dark:text-slate-200 text-lg md:font-bold tracking-5 font-mono"
            >
              {{
          ...
          <div
            class="md:mt-1 text-left text-blue-600 font-mono tracking-widest font-extralight pb-2"
          >
            <!-- user tag -->
            <a
      ...
      <!-- stats -->
      <div
        class="dark:text-slate-400 font-mono text-sm tracking-wide dark:bg-[#141D2F] rounded-xl pt-5 pb-8 grid grid-cols-3 gap-2 text-center bg-[#F6F8FF]"
      >
        <!-- headers -->
      ...
      <!-- SoMe links -->
      <div
        class="dark:text-white font-mono mt-5 grid grid-cols-1 gap-2 pl-3 my-10 sm:flex sm:w-2/3 sm:flex-wrap bg-slate-400"
      >
