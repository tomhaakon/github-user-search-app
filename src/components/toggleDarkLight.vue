<template>
  <div class="mt-5 font-mono">
    <div v-if="isDark" class="flex">
      <button
        @click="toggleDark()"
        class="btn btn-ghost border-0 text-white hover:text-[#697C9A] fill-white hover:fill-[#697C9A]"
      >
        <p class="tracking-widest">dark</p>
        <div class="flex-1">
    ...
    <div v-if="!isDark" class="flex">
      <button
        @click="toggleDark()"
        class="btn btn-ghost border-0 text-[#697C9A] hover:text-black fill-[#697C9A] hover:fill-black"
      >
        <p class="tracking-widest">light</p>
        <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
          <g>
            <path
